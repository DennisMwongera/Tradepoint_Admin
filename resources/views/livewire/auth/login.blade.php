<section>
    <div class="page-header section-height-75">
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-5 col d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
{{--                        <div class="card-header pb-0 text-left bg-transparent">--}}
{{--                            <h3 class="font-weight-bolder text-info text-gradient">{{ __('') }}</h3>--}}
{{--                            <p class="mb-0">{{ __('Create a new acount')}}<br></p>--}}
{{--                            <p class="mb-0">{{__('OR Sign in with these credentials:') }}</p>--}}
{{--                            <p class="mb-0">{{ __('Email ') }}<b>{{ __('support@tradepoint.co.ke') }}</b></p>--}}
{{--                            <p class="mb-0">{{ __('Password ') }}<b>{{ __('12345678') }}</b></p>--}}
{{--                        </div>--}}
                        <div class="card-body">
